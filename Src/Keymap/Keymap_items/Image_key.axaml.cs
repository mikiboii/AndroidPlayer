...
{
    // Avalonia's Bitmap doesn't keep the source URI like WPF's BitmapImage,
    ...
    public string ImageSource
    {
        ...
        set
        {
            try
            {
                ...
                // Accept both avares:// and relative paths.
                // Relative paths are resolved as avares://<this assembly>/<path>
    ...
    public Image_key()
    {
        ...
        // Avalonia: TextInput is the equivalent of PreviewTextInput
        InputField.TextInput += (s, e) => e.Handled = true;

        // Avalonia: to intercept keys before default handling, use tunneling
    ...
    public object GetJsonData()
    {
        ...
        // Avalonia: we stored the path ourselves
